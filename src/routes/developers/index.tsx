...
const developers: QuantumDeveloper[] = [
  {
    ...
    description: "Head of frontend, focused on core architecture, clarity, and emerald glass interfaces.",
    id: "01",
  ...
  },
  {
    ...
    links: {
      ...
      linkedin: "https://www.linkedin.com/in/lingeswara-reddy-diguvapati-965a032ba/"
    },
    accent: "#b3ff57",
  ...
  return (
    <div class="relative min-h-screen overflow-hidden bg-[#050505] text-[#f0fff0]">
      ...
      <div class="pointer-events-none fixed inset-0 z-0">
        ...
        <div class="quantum-orb quantum-orb-float absolute top-1/4 -right-40 h-[500px] w-[500px] rounded-full bg-[#ff4fd8]/8 blur-[130px]" style="animation-delay: -5s" />
        <div class="quantum-orb quantum-orb-float absolute -bottom-36 left-1/3 h-[420px] w-[420px] rounded-full bg-[#6ffffd]/10 blur-[110px]" style="animation-delay: -10s" />
        ...
        <div class="mx-auto max-w-5xl space-y-12">
          ...
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {developers.slice(0, 3).map((dev) => (
              <article 
                key={dev.id}
                class="quantum-card group relative mx-auto flex w-full max-w-[260px] flex-col bg-white p-2 rounded-[1.75rem] shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_36px_rgba(0,0,0,0.14)] h-full"
              >
                {/* Image Block */}
                <div class="relative overflow-hidden rounded-[1.25rem] bg-gray-100 aspect-square">
                  <img src={dev.photo} alt={dev.name} class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                ...
                <div class="flex flex-1 flex-col pt-4 px-1">
                  <div class="mb-2.5">
                    <div class="flex items-center gap-1.5">
                      <h2 class="max-w-[calc(100%-1.5rem)] text-[13px] font-black tracking-tight text-gray-900 font-sans italic uppercase leading-none">{dev.name}</h2>
                  ...
                  <a
                    ...
                    class="mt-auto group/btn relative flex items-center justify-center gap-1.5 rounded-full bg-black py-2.5 text-[8px] font-black uppercase tracking-widest text-white transition-all hover:bg-gray-800 active:scale-95 shadow-md"
                  >
          ...
          <div class="mx-auto flex flex-wrap justify-center gap-8">
            {developers.slice(3, 5).map((dev) => (
              <article 
                key={dev.id}
                class="quantum-card group relative flex w-full max-w-[260px] flex-col bg-white p-2 rounded-[1.75rem] shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_36px_rgba(0,0,0,0.14)] h-full"
              >
                {/* Image Block */}
                <div class="relative overflow-hidden rounded-[1.25rem] bg-gray-100 aspect-square">
                  <img src={dev.photo} alt={dev.name} class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
