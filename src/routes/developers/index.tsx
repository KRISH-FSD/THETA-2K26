        ...
        <div class="mx-auto max-w-5xl px-6 sm:px-12 lg:px-20">
          ...
          <div class="mx-auto flex flex-wrap justify-center gap-8">
            {developers.slice(3, 5).map((dev) => (
              <article
                key={dev.id}
                class="quantum-card group relative flex h-full w-full max-w-[260px] flex-col rounded-[1.75rem] bg-white p-2 shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_36px_rgba(0,0,0,0.14)]"
              >
                {/* Image Block */}
                <div class="relative aspect-square overflow-hidden rounded-[1.25rem] bg-gray-100">
                  <img
