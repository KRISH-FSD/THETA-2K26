...
const EVENTS: EventData[] = [
  ...
  },
  {
    ...
    tags: ["Mind on Leg", "Lucky Box", "Reflex"],
    desc: "Mind on Leg and Lucky Box running in the Sportiva sports arena.",
  },
  {
    id: 5,
    time: "11:00 AM",
    ...
    subtitle: "Sportiva rapid-fire cricket clash",
    venue: "Basketball Court",
    cat: "fun",
    img: "https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=1200",
    tags: ["Cricket", "Overs", "Chase"],
    desc: "A dedicated One Over Cricket event in the Sportiva cluster with the same Day 2 sports schedule.",
...
export default component$(function Day2Roadmap() {
  ...
  return (
    <div class="rm-page rm-page--day2">
      ...
      <div class="rm-scene-gallery"><div class="rm-scene-art"><img src="/roadmap-day2/i1.webp" alt="Day 2 background" loading="lazy" decoding="async" /></div></div>
