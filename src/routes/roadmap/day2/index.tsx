...
const EVENTS: EventData[] = [
  { id: 1, time: "09:00 AM", endTime: "10:00 AM", title: "Day 2 Morning Briefing",
    subtitle: "Second day kickoff for Theta 2026", venue: "Main Auditorium, Block A", cat: "opening",
    fee: "Free", team: "Open to all", prize: "Daily showcase",
    img: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1200&auto=format&fit=crop",
    tags: ["Daily sync", "Theme progress", "Campus update"],
    desc: "The second day signal for Theta 2026 with the morning address, daily highlights, and the second full crowd briefing of the fest." },
  ...
  { id: 7, time: "07:00 PM", endTime: "09:00 PM", title: "Day 2 Cultural Night",
    ...
    desc: "The night wrap with music, campus performances, and a high-energy close to the second day of the roadmap." },
];
...
export default component$(function Day2Roadmap() {
  ...
  return (
    <div class="rm-page" key="roadmap-day-2">
...
export const head: DocumentHead = {
  ...
  meta: [{ name: "description", content: "Day 2 roadmap for Theta 2026 — S-curve timeline, GSAP card reveals, Ben 10 theme." }],
};
